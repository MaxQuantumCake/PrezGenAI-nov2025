...
# Modèle d'embedding (doit être le même que celui utilisé pour l'indexation)
...
def search_faq_semantic(client, query_text, model):
    """Effectue une recherche sémantique KNN dans la FAQ"""
...
def main():
    ...
    print("\n" + "=" * 70)
    print("RECHERCHE SÉMANTIQUE (KNN)")
    print("=" * 70)
    ...
    display_results(response_semantic, query_text, search_type="sémantique")
